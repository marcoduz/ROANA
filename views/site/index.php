    ...
    <div class="body-content">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-outline-secondary" href="http://localhost/roana/web/index.php?r=usuario">User</a></p>
            </div>
            <div class="col-lg-4">
                <h2>Categorias</h2>
            ...
            <div class="col-lg-4">
                ...
                <p><a class="btn btn-outline-secondary" href="http://localhost/roana/web/index.php?r=pedido">Pedido</a></p>
            </div>
        </div>
