...
--
-- Host: 127.0.0.1
-- Tempo de geração: 31-Out-2022 às 18:39
...
INSERT INTO `user` (`id`, `username`, `email`, `password`, `permissao`) VALUES
(1, 'biasus', 'biasus@gmail.com', '123', '1');
...
--
ALTER TABLE `pedido`
  ADD CONSTRAINT `Pedido_fk0` FOREIGN KEY (`Usuarioid`) REFERENCES `user` (`id`);
